...
//speed
//Split the the units into two distance and time and then convert each one alone
...
//convert the to unit to celisus and then gives the new value
